package com.hitsuni.section01.object;
...
public class Application {
    public static void main(String[] args) {
        ...
        * 인스턴스가 생성 될 때 사용한 full class name + @ + 16진수 해시코드가 문자열로 변환
        ...
        * */
        ...
        /* 레퍼런스 변수를 출격하면 자동으로 toString() 을 호출한다. 이 점을 이용하여 toString()를 재정의해서 사용한다. */
        System.out.println(book1);
        System.out.println(book2);
        System.out.println(book3);

        Book book4 = new Book(4, "홍단자", "저자", 30000);
        Book book5 = new Book(4, "홍단자", "저자", 30000);

        /* 동일 객체 : 주소가 동일한 인스턴스
        * 동등 객체 : 주소가 다르더라도 필드 값이 동일한 인스턴스
        * Object의 hashCode(), equals()는 주소값을 기반으롣 동일 객체에 대한 판단을 하지만,
        * Book에 재작성된 메소드는 동등 객체에 대한 판단을 하도록 한다.
        * */
