...
public class Application {
    public static void main(String[] args) {
         ...
         * 캡슐화의 원칙에 따라 작성하기는 했으나 캡슐화가 의미 없을 정도로 필드명을 그대로 사용한
         * getter setter 메소드로 인해 유지보수성이 좋지 않다. 단, 미리 모든 필드에 접근
         * 가능성을 염두해 두고 작성 해두고 있는 관례로 인해 현재도 많이 사용되고 있는 형태이다.
         * */
