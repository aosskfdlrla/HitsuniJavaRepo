...
public class Application1 {
    public static void main(String[] args) {
        /* 스트림의 최종 연산 중 하나인 calculating 을 이해하고 사용할 수 있다. */
        ...
        /* 결과 없음을 나타내는 명확한 요구가 있는 메소드의 반환 형식으로는 Optional 사용 */
        ...
        /* 중간 연산 이후 최종 연산을 수행 */
        int addSum = IntStream.rangeClosed(1, 10).filter(i -> i % 2 == 1).sum();
        System.out.println("OddSum : " + addSum);
    }
}
