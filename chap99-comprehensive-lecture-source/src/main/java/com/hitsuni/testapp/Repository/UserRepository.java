package com.hitsuni.testapp.Repository;

import com.hitsuni.testapp.aggregate.BloodType;
import com.hitsuni.testapp.aggregate.User;
import com.hitsuni.testapp.stream.MyObjectOutputStream;
...
public class UserRepository {
    ...
    private static final String FILE_PATH = "src/main/java/com/hitsuni/testapp/db/userDB.dat";
    ...
    public UserRepository() {
        ...
        * */
        ...
        if(!file.exists()) {
            ...
            users.add(new User(2, "user02", "pass02", 23, new String[] {"게임"}, BloodType.AB));
            users.add(new User(3, "user03", "pass03", 24, new String[] {"영화감상", "독서"}, BloodType.O));
