...
public class FireCar extends Car {
     ...
     * 단, 생성자는 상속 받지 못하며 부모의 private 멤버는 접근이 불가능 하다.
     * */
    ...
    * @Override 어노테이션 : 오버라이딩 성립 요건을 체크하여 성립 되지 않는 경우 컴파일 에러를 발생 시킨다.
    * */
    @Override
    public void soundHorn() {
        if(isRunning()) {
            System.out.println("빠아아아앙~~!빠아아앙~~~!!!!!");
        } else {
    ...
    public void sprayWater() {
        System.out.println("물을 뿌립니다~! 촤차차차차차찿ㄱ");
    }
}
